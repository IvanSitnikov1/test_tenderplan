...
class TestCeleryTasks(unittest.TestCase):
    ...
    def test_parse_form_task(self):
        form_url = 'https://zakupki.gov.ru/epz/order/notice/printForm/' \
                   'viewXml.html?regNumber=0338300047924000069'
        result = ParseFormTask().apply_async(args=[form_url]).get()
        self.assertEqual(result,
                         '"https://zakupki.gov.ru/epz/order/notice/'
                         'printForm/viewXml.html?regNumber=0338300047'
                         '924000069" - "2024-03-21T16:38:28.857+12:00"')
